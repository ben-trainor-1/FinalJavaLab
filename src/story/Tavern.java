...
public class Tavern {
    ...
    public static void main(String[] args) throws Exception {
        ...
        //Round II
        Graphics.textInline(Colors.RED_BOLD_BRIGHT + "\"Níðingr, vile person. Headstrong boy, you can manipulated to do anything.\"\n" + Colors.ANSI_RESET);
        ...
        Graphics.textInline(Colors.ANSI_YELLOW + "1) \"Jealousy is a disease. Get well soon.\"\n"
                                                ...
                                                + "3) \"GIT GUD\"\n"
                                                + "4) \"It is dangerous to use your whole vocabulary in one sentence. At least I survived his wrath.\n You could not even make out of the cave! Calling you an idiot would be an insult to all the stupid people.\"\n" + Colors.ANSI_RESET);
        input = in.nextInt();
        do{
            if(input == 1 || input == 2 || input == 3){
